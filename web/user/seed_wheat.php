...
if(isset($_POST['submit'])){
    ...
    $stock_remQTY=$stock_row['wheatQTY']-$wheatQTY;

    if($wheatQTY<=$stock_row['wheatQTY']){
        $sql="INSERT INTO seed(farmerID,wheatQTY) VALUES('$farmerID_S','$wheatQTY')";
        mysqli_query($con,$sql);
        mysqli_query($con,"UPDATE seed SET wheatQTY='$stock_remQTY' WHERE seedID='4'");
...
if(isset($_POST['submit1'])){
    ...
    if($wheatQTY<=$stock_row['wheatQTY']){
        ...
        $sql="UPDATE seed SET wheatQTY='$wheatQTY', cancel='0' WHERE seedID='$application_row[seedID]'";
        mysqli_query($con,$sql);
        mysqli_query($con,"UPDATE seed SET wheatQTY='$stock_remQTY' WHERE seedID='4'");

        shout("application successfull");
    }else{
        shout("application fails!! exceed quantity of wheat in stock");
    }   
}
?>
    ...
    <body>
        ...
        <div id="right" style="background-color:#c4ccd3">
            ...
            <div id="content" style="background-color:#fff;width:91%;margin:auto;padding:2%">
                ...
                <table>
                    <form method="post">
                        <tr> <td>Crop</td> <td><input type="text" name="progress" value="Wheat" readonly="readonly"/> </td> </tr>

                        <tr> <td>wheat In stock(50kg bags)</td> <td><input type="text" name="stock" value="<?php echo $stock_row['wheatQTY'] ?>" readonly="readonly"/> </td> </tr>
                        <tr> <td>Quantity(50kg bags)</td> <td><input type="text" name="wheatQTY" placeholder="number of bags" required/> </td> </tr>
        ...
        echo "application not successful reapply";
                ...
                <table>
                    <form method="post">
                        ...
                        <tr> <td>soghum In stock(50kg bags)</td> <td><input type="text" name="stock" value="<?php echo $stock_row['wheatQTY'] ?>" readonly="readonly"/> </td> </tr>
                        <tr> <td>Quantity(50kg bags)</td> <td><input type="text" name="wheatQTY" placeholder="number of bags" required/> </td> </tr>
