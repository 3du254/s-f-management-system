<?php
    ...
    $sql="SELECT * from farm,user WHERE user.farmerID=farm.farmerID AND farm.crop='maize'";
...
<body>
    ...
    <div id="wrapperR" style="background-color:#c4ccd3">
        ...
        <div id="content" style="background-color:#fff; padding:20px; width:70%; margin:2vh auto auto 2vw;">
           <h3 style="margin:0px auto 0px 0; padding:3px;border-bottom:1px solid #e3e6e7;width:97%">Maize farmers</h3>
            <table style="border-collapse: collapse">

                <thead><tr> <th>#</th> <th>First name</th> <th>Second name</th> <th>Location</th> <th>Farm number</th> <th>Harvested bags</th> <th>progress</th> </tr></thead>
                <?php
                $total=0;
                while($row=mysqli_fetch_array($result)){
                    ...
                    echo "<tr> <td>$row[farmerID]</td> <td>$row[firstName]</td> <td>$row[secondName]</td> <td>$row[Location]</td> <td>$row[farmNo]</td> <td>";
                        ...
                        if($get_bags_row['harvested_bags']==0){
                            ...
                            echo $get_bags_row['harvested_bags'];
                        }
