...
$sql="SELECT * from farm,user WHERE user.farmerID=farm.farmerID AND farm.crop='soghum'";
    ...
    <body>
        ...
        <div id="wrapperR" style="background-color:#c4ccd3">
            ...
            <div id="content" style="background-color:#fff; padding:20px; width:70%; margin:5vh auto auto 2vw;">
                <h3 style="margin:0px auto 0px 0; padding:3px;border-bottom:1px solid #e3e6e7;width:97%">Soghum farmers</h3>
